...
아래 게임 4개는 기존 영상·역할 기록으로 확인한 범위를 소개합니다. 스마트글라스는 Android 교육 팀 프로젝트로 별도 구분했습니다.

### 6. LostArk 모작

> 하우징과 아이소메트릭 보스 전투를 시연한 학습용 프로젝트

- 핵심 역할: 플레이어 담당 — 스킬 사용 조건·피격 상태, 피해 수치·전투 효과 연결
- 상세 설명: 영상에서 확인되는 플레이어 기능과 팀의 하우징·보스·시네마틱을 구분

**[프로젝트 상세 설명 →](projects/other-projects/lostark-clone.md)** · [시연 영상](https://youtu.be/kG_SeeEKs6A)
...
본인 구현·팀 공통 기반·AI 생성 산출물·외부 도구를 구분합니다. 저장된 테스트 기록은 당시 조건의 결과이며, 미측정 성능·미완료 기능은 완료 성과로 적지 않습니다. 추가 4개 프로젝트는 영상과 기존 기여 기록 중심으로 설명하며 내부 알고리즘을 추정하지 않습니다.
